...
| [Synchronisation](https://synchronisation.anneraud.fr/)                | File synchronization (Syncthing)              | Private | Bruxelles  | Ansible      | ![Status](<https://etat.anneraud.fr/api/v1/endpoints/services_synchronisation-(syncthing)/uptimes/30d/badge.svg>)                  |
