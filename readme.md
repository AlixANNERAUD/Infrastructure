...
| [VPN](https://tailscale.anneraud.fr/)                                  | Virtual private network (Tailscale/Headscale) | Public  | Luxembourg | Ansible      | ![Status](<https://etat.anneraud.fr/api/v1/endpoints/administration_vpn-(tailscale)/uptimes/30d/badge.svg>)                        |
| [VPN console](https://tailscale.anneraud.fr/admin/)                    | VPN administration console                    | Public  | Luxembourg | Ansible      | ![Status](https://etat.anneraud.fr/api/v1/endpoints/administration_vpn-console/uptimes/30d/badge.svg)                              |
